...
const StickyRow$1 = /*#__PURE__*/memo(StickyRow);
...
function DataGrid({
  ...
  const [stickyRowIndex, setStickyRowIndex] = useState(undefined);
  ...
  function getViewportRows() {
    ...
    for (let viewportRowIdx = startRowIdx; viewportRowIdx <= endRowIdx; viewportRowIdx++) {
      ...
      if (typeof row === 'object' && row.isStickyRow) {
        rowElements.push( /*#__PURE__*/jsx(StickyRow$1, {
          content: row.content,
          isStuck: false,
          top: top
        }, key));
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    }), stickyRowIndex !== undefined && stickyRowIndexes.length ? /*#__PURE__*/jsx(StickyRow$1, {
      content: rows[stickyRowIndexes[stickyRowIndex]].content,
      isStuck: true,
      top: headerRowHeight
    }) : null, rows.length === 0 && noRowsFallback ? noRowsFallback : /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsx("div", {
        style: {
